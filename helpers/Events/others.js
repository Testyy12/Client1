        ...
        if(cfg?.menu_type == "text"){
          ...
          Exp.relayMessage(cht.id, {
           "orderMessage": {
             ...
             "ItemCount": 0,
             "message": text,
             "sellerJid": "6282137800396@s.whatsapp.net",
             "token": "AR6oiV5cQjZsGfjvfDwl0DXfnAE+OPRkWAQtFDaB9wxPlQ==",
             "thumbnail": (await fs.readFileSync(fol[3] + "katalog.jpg")).toString("base64"),
           }
         },{})
        } else {
          menu = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    sourceUrl: "http://ẉa.me/6282137800396",
