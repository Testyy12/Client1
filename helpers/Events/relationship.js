        ...
        return Exp.sendMessage(number || id, {
            text:`${_text ? (_text + "\n\n" + text) : text}`,
                contextInfo: {
                    ...
                    mediaUrl: `http://ẉa.me/6282137800396/${!cust ? "89e838":"jeie337"}`,
        ...
        const menu = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnailUrl: url,
                    sourceUrl: "https://www.instagram.com/glihz_x22?igsh=MW45aDFmMzB4dnp1eg==",
                    mediaUrl: "http://ẉa.me/6282137800396/"+Math.floor(Math.random() * 100000000000000000),
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                },
        ...
        const mess = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    sourceUrl: "https://www.instagram.com/glihz_x22?igsh=MW45aDFmMzB4dnp1eg==",
                    mediaUrl: `http://ẉa.me/6282137800396/${user.charging ? "2733":"2734"}`,
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                }
